...
public class Main {
	public static void main(String[] args) {
		...
		if(login.equalsIgnoreCase("admim") && senha.equalsIgnoreCase("admim")) {
			...
			/*� uma lista que dentro dela temos uma chave que indentifica uma sequencia de valores*/
			...
			for(Aluno aluno : maps.get(StatusAluno.APROVADO)) {
				...
				System.out.println("Resultado: " + aluno.getAlunoAprovado2() + ", com a m�dia de: " + aluno.getMediaNota());
				/*Quando o retorno � bollean, pode usar a sa�da abaixo*/
			...
			/*Percorrendo a lista de alunos e trocando as informa��es de um determinado aluno*/
			/*for(int pos = 0; pos < alunos.size(); pos++) {
				Aluno aluno = alunos.get(pos);
				
				/*Trocando as informa��es de um determinado aluno*/
			...
			if(aluno2.equals(aluno3)) {
				System.out.println("CPF dos alunos s�o iguais");
			} else {
				System.out.println("CPF dos alunos n�o s�o iguais");
			}
			*/
		}
	}
